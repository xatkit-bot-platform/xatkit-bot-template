...
import com.xatkit.i18n.XatkitI18n;
...
public class GreetingsBotI18n {
    ...
    public static void main(String[] args) {
        ...
        XatkitI18n i18n = new XatkitI18n("i18n/GreetingsBot", Locale.FRANCE);
        ...
        val greetings = intent("Greetings")
                .trainingSentences(i18n.getStringCollection("Greetings"));

        val howAreYou = intent("HowAreYou")
                .trainingSentences(i18n.getStringCollection("HowAreYou"));
        ...
        handleWelcome
                .body(context -> reactPlatform.reply(context, i18n.getString("NiceToMeetYou")))
                .next()
                    /*
        ...
        handleWhatsUp
                .body(context -> reactPlatform.reply(context, i18n.getString("FineAndYou")))
                .next()
                    .moveTo(awaitingInput);
        ...
        val defaultFallback = fallbackState()
                .body(context -> reactPlatform.reply(context, i18n.getString("IDidntGetIt")));
